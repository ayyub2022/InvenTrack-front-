...
const ChartComponent = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const salesResponse = await fetch('https://inventrack-ovku.onrender.com/sales_data');
        const salesData = await salesResponse.json();

        const profitLossResponse = await fetch('https://inventrack-ovku.onrender.com/profit_loss_data'); 
