...
export default function Instock() {
  ...
  useEffect(() => {
    const getItems = async () => {
      try {
        const res = await fetch("https://inventrack-ovku.onrender.com/products");
    ...
    const fetchCategories = async () => {
      try {
        const res = await fetch("https://inventrack-ovku.onrender.com/categories");
        const data = await res.json();
        if (!res.ok) {
          throw new Error(data);
        }
    ...
    const getSales = async () => {
      try {
        const res = await fetch("https://inventrack-ovku.onrender.com/product_sales");
        const data = await res.json();
        if (!res.ok) {
          throw new Error(data);
        }
